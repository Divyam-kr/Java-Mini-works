...
public class PlayCard {
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("\n--- Card Mania ---");
            System.out.println("1. Print the existing deck");
            System.out.println("2. Find any card of your choice");
            System.out.println("3. Deal cards");
            System.out.println("4. Sort the deck");
            System.out.println("5. Check if two cards are the same");
            System.out.println("6. Quit");
            System.out.print("Enter the option you want to go with: ");
